			...
			.addEmbed(() =>
				EmbedTemplates.createCamouflaged((embed) =>
					embed
						...
						.setColor(!isNullOrUndefined(game.outcome) ? Blackjack.Outcomes[game.outcome.outcome].color() : embed.data.color!)
						.setDescription(
					...
					(row, customId) =>
						row.addButtonComponent((btn) =>
							btn
								...
								.setStyle(isNullOrUndefined(game.outcome) ? ButtonStyle.Primary : ButtonStyle.Secondary)
