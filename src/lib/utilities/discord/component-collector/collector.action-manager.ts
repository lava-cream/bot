import { Collection, MessageComponentType, Snowflake } from 'discord.js';
 ...
 */
export class CollectorActionManager<in out T extends MessageComponentType, Cached extends boolean> {
	/**
	...
	public set(actions: CollectorAction<T, Cached>[]): number {
		...
		return actions.reduce((manager, action) => {
